...
Note that data distributions are very different between technologies ("UMI" technologies (inDrop, 10x) vs. "TMP" technologies (e.g. SS2)). Perform the
metanalyses separately for the two technologies
```{r}
...
ggsave("plots/heatmap.avg.expression.proteasomal.genes.UMI.pdf", plot=h, height=6, width=13)
...
ggsave("plots/heatmap.avg.expression.marker.genes.UMI.pdf", plot=h, height=4, width=13)
...
h <- make.heatmap(data.heat, genes=proteasomal.genes, brewer.palette = "PiYG")
ggsave("plots/heatmap.avg.expression.proteasomal.genes.TPM.pdf", plot=h, height=6, width=10)

markers <- c("HAVCR2","PDCD1","LAG3","TOX","TOX2","ENTPD1","CTLA4","CXCL13","GZMB","IL7R","TCF7","GZMK","GZMM","ANXA1","CCL5")
h <- make.heatmap(data.heat, genes=markers, brewer.palette = "PiYG")
ggsave("plots/heatmap.avg.expression.marker.genes.TPM.pdf", plot=h, height=4, width=10)
```
